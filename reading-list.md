...
4. `MovieChat: From Dense Token to Sparse Memory for Long Video Understanding` (CVPR 2024)  
...
5. `MLVU: A Comprehensive Benchmark for Multi-Task Long Video Understanding` (arXiv 2024)  
...
6. `LongVideoBench: A Benchmark for Long-context Interleaved Video-Language Understanding` (NeurIPS 2024 Datasets and Benchmarks)  
   Why first: strong reference point for long-context multimodal reasoning.  
   Link: https://arxiv.org/abs/2407.15754

7. `Temporal Reasoning Transfer from Text to Video` (ICLR 2025)  
...
8. `Re-thinking Temporal Search for Long-Form Video Understanding` (CVPR 2025)  
...
9. `VITED: Video Temporal Evidence Distillation` (CVPR 2025)  
...
10. `On the Consistency of Video Large Language Models in Temporal Comprehension` (CVPR 2025)  
...
11. `Omnia de EgoTempo: Benchmarking Temporal Understanding of Multi-Modal LLMs in Egocentric Videos` (CVPR 2025)  
...
12. `Seq2Time: Sequential Knowledge Transfer for Video LLM Temporal Grounding` (CVPR 2025)  
...
14. `VideoComp: Advancing Fine-Grained Compositional and Temporal Alignment in Video-Text Models` (CVPR 2025)  
...
15. `Motion-Grounded Video Reasoning: Understanding and Perceiving Motion at Pixel Level` (CVPR 2025)  
...
16. `VideoEspresso: A Large-Scale Chain-of-Thought Dataset for Fine-Grained Video Reasoning via Core Frame Selection` (CVPR 2025)  
...
17. `UniVTG: Towards Unified Video-Language Temporal Grounding` (ICCV 2023)  
...
18. `ProTeGe: Untrimmed Pretraining for Video Temporal Grounding by Video Temporal Grounding` (CVPR 2023)  
...
19. `Localizing Moments in Long Video Via Multimodal Guidance` (ICCV 2023)  
...
20. `Scanning Only Once: An End-to-end Framework for Fast Temporal Grounding in Long Videos` (ICCV 2023)  
...
21. `ARGUS: Hallucination and Omission Evaluation in Video-LLMs` (ICCV 2025)  
...
22. `Enrich and Detect: Video Temporal Grounding with Multimodal LLMs` (ICCV 2025)  
...
23. `Compositional Video Understanding with Spatiotemporal Structure-based Transformers` (CVPR 2024)  
...
24. `Benchmarking the Robustness of Temporal Action Detection Models Against Temporal Corruptions` (CVPR 2024)  
...
25. `VideoRefer Suite: Advancing Spatial-Temporal Object Understanding with Video LLM` (CVPR 2025)  
...
26. `Towards Debiasing Temporal Sentence Grounding in Video` (arXiv 2021)  
    Focus: old but still important anchor for annotation-bias pathology.  
    Link: https://arxiv.org/abs/2111.04321

27. `Temporal Sentence Grounding in Videos: A Survey and Future Directions` (TPAMI 2023 / arXiv)  
